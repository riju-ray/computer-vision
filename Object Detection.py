...
configFile = r'ssd_mobilenet_v3_large_object_2021_06_18.pbtxt'
frozenModel = r'frozen_inference_graph.pb'
model = cv.dnn_DetectionModel(frozenModel,configFile)

# Creating the class file

classFile = r'object.names'
classNames = []
with open(classFile, 'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')
print(classNames, len(classNames)) #classNames ==> Contains all the 80 classes from the object dataset
...
cap = cv.VideoCapture(r'trafficroad.mp4')
